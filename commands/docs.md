...
Read `lanes/docs.md` and `AGENTS.md`. Need a GitHub issue. Open a PR. Use /mermaid when you write a PR. Put the after-state mermaid on the existing docs page in the same PR. Do not merge.
