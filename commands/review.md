...
Read `lanes/review.md` and `AGENTS.md`. Run /code-review on the given PR only. Leave GitHub review comments. Request changes when required mermaid diagrams are missing. Do not implement. Do not merge.
