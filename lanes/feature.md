...
Do not expand the ask. Follow /tdd, /implement, /unslop. Use /mermaid when you write a PR. Put the after-state mermaid on the existing docs page for that subsystem in the same PR. No per-PR copy.
