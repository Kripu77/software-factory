...
Do not implement. Do not merge. Leave GitHub review comments. Use short paragraphs. A blank line before any list or fence. Never a line that starts with #n. Cite the ticket as a markdown link. A review summary may use headings. Request changes when the required mermaid diagrams are missing, when a PR body is one wall of text, a line starts with #n, or a fence or list has no blank line in front of it.
