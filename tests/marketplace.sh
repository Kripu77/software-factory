...
need_file "skills/lead/SKILL.md"
grep -q '^name: lead$' "$ROOT/skills/lead/SKILL.md" || fail "Codex lead skill should declare lead"
need_text skills/lead/SKILL.md "factory.sh floor"
